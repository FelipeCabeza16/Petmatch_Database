...
-- -----------------------------------------------------
-- Table `petmatch_dev`.`http_method`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `petmatch_dev`.`http_method` (
  `id_http_method` INT NOT NULL,
  ...
  UNIQUE INDEX `breed_UNIQUE` (`http_method` ASC) VISIBLE)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `petmatch_dev`.`log`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `petmatch_dev`.`log` (
  ...
  `http_method_id_http_method` INT NOT NULL,
  `modulo_id_modulo` INT NOT NULL,
  `ip_address` VARCHAR(100) NULL,
  `device` VARCHAR(100) NULL,
  PRIMARY KEY (`id_log`),
  INDEX `fk_log_user1_idx` (`user_id_user` ASC) VISIBLE,
  INDEX `fk_log_http_method1_idx` (`http_method_id_http_method` ASC) VISIBLE,
  INDEX `fk_log_modulo1_idx` (`modulo_id_modulo` ASC) VISIBLE,
  CONSTRAINT `fk_log_user1`
    FOREIGN KEY (`user_id_user`)
    REFERENCES `petmatch_dev`.`user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_log_http_method1`
    FOREIGN KEY (`http_method_id_http_method`)
    REFERENCES `petmatch_dev`.`http_method` (`id_http_method`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
